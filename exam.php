...
$number_sales =(int) $_GET['n'];

$sql = "SELECT * FROM sales_q";
...
$query = "SELECT * from sales_q WHERE question_number =$question_no";
$result = $db_con->query($query) or die($db_con->error);
$sales_q = $result->fetch_assoc();

// query to get the sales_c from the database;

$query = "SELECT * from sales_c WHERE question_number = $question_no";
$sales_c = $db_con->query($query) or die($db_con->error);
...
<!DOCTYPE html>
     ...
     <a href="index.php"> <h5 class="my-0 mr-md-auto font-weight-normal"><img src="images/logo.png" alt=""></h5></a> 
        ...
        <div class="container">
            <div class="current">
                ...
                <form id="question-form" class="needs-validation" novalidate action="salesprocess.php" method="POST">
                    <p class="questions" id="qname"> Question:
                        <?php echo $sales_q['questions'] ?>
                    </p>
                    <div class="col-md-7">
                     <?php while ($row = $sales_c->fetch_assoc()) : ?>
 ...
 <input type="hidden" name="number_sales" value="<?php echo $number_sales; ?>">
 </div>    
</div>
    </body>
