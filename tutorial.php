...
<div class="row">
    <div class="col-md-5 col-sm-5 col-xs-5 ">
        <img src="images\more_info_img1@2x.jpg">
    ...
    <div class="col-md-7 col-sm-7 col-md-7 col-xs-7">
     ...
     <div class="wrapper">
    <a href="Refined Solar Manual for Training.docx" class="fancy-button pop-onhover bg-gradient1"download>
        <span>Download</span>
    </a>
    </div>
    </div>
 ...
 <h5>Be part of Graduate Solar Boot Camp in Lagos Nigeria</h5>
 <div class="wrapper">
    <a href="quiz.php?n=1" class="fancy-button pop-onhover bg-gradient1" role="button">
