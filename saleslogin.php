...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT id, score FROM sales WHERE surname = '$surname' and email = '$email'";
        ...
        <div class="row">
         <div class="col-sm-4 col-md-6 left">               
                <form class="form-signin" method="POST" action="">
                    ...
                    <input name="surname" type="text" id="inputEmail" class="form-control" placeholder="Surname" required autofocus>
                    <br>
